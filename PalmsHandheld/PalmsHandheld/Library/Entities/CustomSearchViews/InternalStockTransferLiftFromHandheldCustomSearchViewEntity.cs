...
//// This file (InternalStockTransferLiftFromHandheldCustomSearchViewEntity.cs) has been auto-generated by PALMS Entity Generation Tool on 'Friday, December 29, 2017' at '4:58:47 PM'
...
{
	[Serializable]
	public partial class InternalStockTransferLiftFromHandheldCustomSearchViewEntity : Entity
	{
		#region Enums
		...
		public EntityKey<InternalStockTransferLiftFromHandheldCustomSearchViewEntity> GetUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
					return new InternalStockTransferLiftFromHandheldCustomSearchViewUniqueKey()
					{
						primaryCompanyID = (int?)primaryCompanyID
					};
			}
		...
		public EntityKey<InternalStockTransferLiftFromHandheldCustomSearchViewEntity> GetBlankUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
