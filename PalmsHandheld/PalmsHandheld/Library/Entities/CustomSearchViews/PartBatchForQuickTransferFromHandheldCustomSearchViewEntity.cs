...
//// This file (PartBatchForQuickTransferFromHandheldCustomSearchViewEntity.cs) has been auto-generated by PALMS Entity Generation Tool on 'Thursday, July 21, 2016' at '12:11:27 AM'
...
{
	[Serializable]
	public partial class PartBatchForQuickTransferFromHandheldCustomSearchViewEntity : Entity
	{
		#region Enums
		...
		public EntityKey<PartBatchForQuickTransferFromHandheldCustomSearchViewEntity> GetUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
					return new PartBatchForQuickTransferFromHandheldCustomSearchViewUniqueKey()
					{
						primaryCompanyID = (int?)primaryCompanyID
						, warehouseID = (int?)warehouseID
						, costBucketID = (int?)costBucketID
		...
		public EntityKey<PartBatchForQuickTransferFromHandheldCustomSearchViewEntity> GetBlankUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
