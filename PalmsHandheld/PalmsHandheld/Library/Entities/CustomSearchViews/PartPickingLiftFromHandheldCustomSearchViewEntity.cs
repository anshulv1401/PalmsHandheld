...
//// This file (PartPickingLiftFromHandheldCustomSearchViewEntity.cs) has been auto-generated by PALMS Entity Generation Tool on 'Thursday, March 2, 2017' at '3:01:28 PM'
...
{
	[Serializable]
	public partial class PartPickingLiftFromHandheldCustomSearchViewEntity : Entity
	{
		#region Enums
		...
		public EntityKey<PartPickingLiftFromHandheldCustomSearchViewEntity> GetUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
					return new PartPickingLiftFromHandheldCustomSearchViewUniqueKey()
					{
						primaryCompanyID = (int?)primaryCompanyID
						, warehouseID = (int?)warehouseID
						, costBucketID = (int?)costBucketID
		...
		public EntityKey<PartPickingLiftFromHandheldCustomSearchViewEntity> GetBlankUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
