...
{
    public class UserLogOutConfiguration : WebServiceAccessConfiguration<UserAuthenticationEntity>
    {
        private String WebServiceName;
        private String WebServicePath;

        public UserLogOutConfiguration()
        {
            WebServiceName = "UserLogOut.asmx";
