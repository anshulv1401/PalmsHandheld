...
//// This file (StockTakingInstructionResultEntity.cs) has been auto-generated by PALMS Entity Generation Tool on '22 May 2015' at '15:04:36'
...
{
	[Serializable]
	public partial class StockTakingInstructionResultEntity : Entity
	{
		#region Enums
		...
		public new enum Field
		{
			...
			, StockTakingInstructionID_StockTakingInstructionNo
		...
		public string stockTakingInstructionID_StockTakingInstructionNo;
		...
		{
			return (IEntityKey<Entity>)new StockTakingInstructionResultPrimaryKey()
			{
				costBucketID = (int)costBucketID
				, primaryCompanyID = (int)primaryCompanyID
				, stockTakingInstructionResultID = (int)stockTakingInstructionResultID
		...
		public EntityKey<StockTakingInstructionResultEntity> GetUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
					return new StockTakingInstructionResultUniqueKey()
					{
						costBucketID = (int?)costBucketID
		...
		public EntityKey<StockTakingInstructionResultEntity> GetBlankUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
		...
		public object GetValue(Field field)
		{
			switch (field)
			{
				...
				case Field.StockTakingInstructionID_StockTakingInstructionNo:
					return stockTakingInstructionID_StockTakingInstructionNo;
		...
		public void SetValue(Field field, int? value)
		{
			...
			{
				case Field.StockTakingInstructionResultID:
					stockTakingInstructionResultID = value;
					break;
				case Field.PrimaryCompanyID:
		...
		public void SetValue(Field field, string value)
		{
			switch (field)
			{
				...
				case Field.PrimaryCompanyID_PrimaryCompanyName:
					...
					break;
				case Field.StockTakingInstructionID_StockTakingInstructionNo:
					stockTakingInstructionID_StockTakingInstructionNo = value;
					break;
				case Field.WarehouseID_DocumentNoPrefix:
		...
		{
			if ((Field)field == Field.StockTakingInstructionResultID)
			{
				return true;
			}
			else
