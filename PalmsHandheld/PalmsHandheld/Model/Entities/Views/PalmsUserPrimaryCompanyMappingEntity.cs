...
//// This file (PalmsUserPrimaryCompanyMappingEntity.cs) has been auto-generated by PALMS Entity Generation Tool on '12 January 2012' at '16:41:12'
...
{
	[Serializable]
	public partial class PalmsUserPrimaryCompanyMappingEntity : Entity
	{
		#region Enums
		...
		public override IEntityKey<Entity> GetUniqueKey(string uniqueKey)
		{
			  if (uniqueKey == "" && uniqueKey == "Default")
            {
			 ...
			 return (IEntityKey<Entity>) new PalmsUserPrimaryCompanyMappingUniqueKey()
					{
							palmsUserID = (int?)palmsUserID
						, primaryCompanyID = (int?)primaryCompanyID
					};		
		...
		public EntityKey<PalmsUserPrimaryCompanyMappingEntity> GetBlankUniqueKey(UniqueKey uniqueKey)
		{
            switch (uniqueKey)
			{
				case UniqueKey.Default:
					return new PalmsUserPrimaryCompanyMappingUniqueKey();
			}
