...
//// This file (EnumerationEntity.cs) has been auto-generated by PALMS Entity Generation Tool on '12 January 2012' at '16:40:13'
...
{
	[Serializable]
	public partial class EnumerationEntity : Entity
	{
		#region Enums
		...
		public override IEntityKey<Entity> GetUniqueKey(string uniqueKey )
		{
            ...
            return (IEntityKey<Entity>) new EnumerationUniqueKey_Name()
					{
						enumerationName = (string)enumerationName
					};	
		}

		public EntityKey<EnumerationEntity> GetUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Value:
					return new EnumerationUniqueKey_Value()
					{
						enumerationType = (string)enumerationType
						, enumerationValue = (int?)enumerationValue
					};
				case UniqueKey.Name:
					return new EnumerationUniqueKey_Name()
					{
						enumerationName = (string)enumerationName
						, enumerationType = (string)enumerationType
					};
		...
		public EntityKey<EnumerationEntity> GetBlankUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Value:
		...
		{
			if ((Field)field == Field.EnumerationID)
			{
				return true;
			}
			else
