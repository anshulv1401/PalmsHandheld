...
//// This file (PartPickingDropFromHandheldCustomSearchViewEntity.cs) has been auto-generated by PALMS Entity Generation Tool on 'Thursday, July 7, 2016' at '9:39:04 AM'
...
{
	[Serializable]
	public partial class PartPickingDropFromHandheldCustomSearchViewEntity : Entity
	{
		#region Enums
		...
		{
			return (IEntityKey<Entity>)new PartPickingDropFromHandheldCustomSearchViewPrimaryKey()
			{
		...
		public EntityKey<PartPickingDropFromHandheldCustomSearchViewEntity> GetUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
					return new PartPickingDropFromHandheldCustomSearchViewUniqueKey()
					{
						primaryCompanyID = (int?)primaryCompanyID
						, warehouseID = (int?)warehouseID
						, costBucketID = (int?)costBucketID
		...
		public EntityKey<PartPickingDropFromHandheldCustomSearchViewEntity> GetBlankUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
