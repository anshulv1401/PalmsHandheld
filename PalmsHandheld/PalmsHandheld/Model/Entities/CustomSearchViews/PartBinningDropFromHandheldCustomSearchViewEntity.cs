...
//// This file (PartBinningDropFromHandheldCustomSearchViewEntity.cs) has been auto-generated by PALMS Entity Generation Tool on 'Friday, June 22, 2018' at '4:07:30 PM'
...
{
	[Serializable]
	public partial class PartBinningDropFromHandheldCustomSearchViewEntity : Entity
	{
		#region Enums
		...
		{
			return (IEntityKey<Entity>)new PartBinningDropFromHandheldCustomSearchViewPrimaryKey()
			{
		...
		public EntityKey<PartBinningDropFromHandheldCustomSearchViewEntity> GetUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
					return new PartBinningDropFromHandheldCustomSearchViewUniqueKey()
					{
						primaryCompanyID = (int?)primaryCompanyID
						, warehouseID = (int?)warehouseID
						, costBucketID = (int?)costBucketID
		...
		public EntityKey<PartBinningDropFromHandheldCustomSearchViewEntity> GetBlankUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
