...
//// This file (QuickTransferDropFromHandheldCustomSearchViewEntity.cs) has been auto-generated by PALMS Entity Generation Tool on 'Friday, August 5, 2016' at '2:25:56 PM'
...
{
	[Serializable]
	public partial class QuickTransferDropFromHandheldCustomSearchViewEntity : Entity
	{
		#region Enums
		...
		{
			return (IEntityKey<Entity>)new QuickTransferDropFromHandheldCustomSearchViewPrimaryKey()
			{
		...
		public EntityKey<QuickTransferDropFromHandheldCustomSearchViewEntity> GetUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
					return new QuickTransferDropFromHandheldCustomSearchViewUniqueKey()
					{
						primaryCompanyID = (int?)primaryCompanyID
						, warehouseID = (int?)warehouseID
						, costBucketID = (int?)costBucketID
		...
		public EntityKey<QuickTransferDropFromHandheldCustomSearchViewEntity> GetBlankUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
