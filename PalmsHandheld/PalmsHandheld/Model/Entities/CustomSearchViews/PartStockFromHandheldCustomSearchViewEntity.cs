...
//// This file (PartStockFromHandheldCustomSearchViewEntity.cs) has been auto-generated by PALMS Entity Generation Tool on '11 December 2014' at '11:45:54'
...
{
	[Serializable]
	public partial class PartStockFromHandheldCustomSearchViewEntity : Entity
	{
		#region Enums
		...
		public EntityKey<PartStockFromHandheldCustomSearchViewEntity> GetUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
					return new PartStockFromHandheldCustomSearchViewUniqueKey()
					{
						warehouseID = (int?)warehouseID
						, primaryCompanyID = (int?)primaryCompanyID
						, costBucketID = (int?)costBucketID
		...
		public EntityKey<PartStockFromHandheldCustomSearchViewEntity> GetBlankUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
