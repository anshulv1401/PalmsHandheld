...
//// This file (CycleCountInstructionResultCustomSearchViewEntity.cs) has been auto-generated by PALMS Entity Generation Tool on 'Tuesday, October 25, 2016' at '10:10:14 AM'
...
{
	[Serializable]
	public partial class CycleCountInstructionResultCustomSearchViewEntity : Entity
	{
		#region Enums
		...
		public EntityKey<CycleCountInstructionResultCustomSearchViewEntity> GetUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
					return new CycleCountInstructionResultCustomSearchViewUniqueKey()
					{
						cycleCountInstructionID = (int?)cycleCountInstructionID
						, warehouseID = (int?)warehouseID
						, primaryCompanyID = (int?)primaryCompanyID
		...
		public EntityKey<CycleCountInstructionResultCustomSearchViewEntity> GetBlankUniqueKey(UniqueKey uniqueKey)
		{
			switch (uniqueKey)
			{
				case UniqueKey.Default:
